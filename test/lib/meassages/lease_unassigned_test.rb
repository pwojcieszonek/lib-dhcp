...
class LeaseUnassigned < Minitest::Test
  ...
  def test_to_json
    json = { "op" => { "code" => "2", "name" => "BOOTREPLY" },
             ...
             "sname" => ".",
             "file" => ".",
             "options" => [{ "name" => "DHCP Message Type", "oid" => 53, "len" => 1, "value" => 11 }] }
    assert_equal json, JSON.parse(@lease_unassigned.to_json)
  end
  ...
  def test_message_type
    ...
    assert_equal 11, @from_json.option53.to_i
  end
  ...
  def test_from_json
    ...
    packet = Lib::DHCP::Message.from_json(
      Lib::DHCP::Message.unpack(
        Lib::DHCP::Message::LeaseUnassigned.new(chaddr: '00:11:22:33:44:55', xid: 1374095120).pack
      ).to_json
    )
    assert_instance_of Lib::DHCP::Message::LeaseUnassigned, packet
  end
